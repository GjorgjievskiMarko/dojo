...
export const buttonVariants = cva("inline-flex items-center justify-center gap-1 py-0 text-center whitespace-nowrap font-bold hover:border-transparent transition-transform transition-shadow focus:outline-none focus-visible:outline-none active:transform active:translate-y-[2px] shadow-lg active:shadow-md [&>svg]:size-6 [&>svg]:pb-0.5 [&>svg]:flex-1", {
  variants: {
    intent: {
      ...
      success: "bg-success text-success border-success-more hover:border-success-more",
      warning: "bg-warning text-warning border-warning-more hover:border-warning-more",
      danger: "bg-danger text-danger border-danger-more hover:border-danger-more"
    },
    variant: {
      contained: "text-inverted border-b border-b-[6px]",
      inverted: " bg-inverted border-b border-b-[6px] border-opacity/50 hover:border-opacity/50",
      neutral: "bg-neutral border-b border-b-[6px] border-neutral-more hover:border-neutral-more",
